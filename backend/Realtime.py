...
def main() -> None:
    ...
    # Initialize the Speech client and configurations
    ...
    with mic_manager as stream:
        ...
        responses = client.streaming_recognize(streaming_request, audio_generator)

        # Process and print the transcription responses
